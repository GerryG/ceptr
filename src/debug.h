...
// debug flags: _debug(D_SPEC|D_SIGNALS|...)
enum {
  D_NONE      =0x0000,
  D_ALL       =0xFFFF,
  D_SPEC      =0x8000,
...
#define DEBUG_DEFAULT_MASK D_ALL
//#define DEBUG_DEFAULT_MASK D_NONE
//#define DEBUG_DEFAULT_MASK D_SIGNALS

// not used, but zero is all filtered,
// DEBUG_DEFAULT_MASK -> G_debug_mask (above) is used
#ifndef DEBUG_MASK
#define DEBUG_MASK 0
#endif
...
int debug_enable(int type);
int debug_disable(int type);
int G_debug_mask;
